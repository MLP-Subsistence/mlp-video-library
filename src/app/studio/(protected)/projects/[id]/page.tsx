...
export default async function WorkspacePage({ params, searchParams }: { params: Promise<{ id: string }>; searchParams: Promise<{ segment?: string }> }) {
  ...
  if (!project) notFound();
  return <Workspace initial={project} initialSegmentId={query.segment ?? null} />;
}
